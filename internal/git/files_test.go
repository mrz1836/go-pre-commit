...
func (ts *FileClassifierTestSuite) TestClassifyFilesBasic() {
	// Create test files
	goFile := ts.createFile(testFileTestGo, "package main\n\nfunc main() {}\n")
...
func (ts *FileClassifierTestSuite) TestFilterGoFiles() {
	// Create test files
	goFile1 := ts.createFile(testFileMainGo, "package main")
...
func (ts *FileClassifierTestSuite) TestFilterTextFiles() {
	...
	goFile := ts.createFile(testFileMainGo, "package main")
	binFile := ts.createBinaryFile("binary.bin", 100)
...
func (ts *FileClassifierTestSuite) TestExcludeByPatterns() {
	...
	ts.Require().Contains(filtered, testFileMainGo)
...
func (ts *FileClassifierTestSuite) TestIsGoFile() {
	tests := []struct {
		...
		{"valid go file", testFileMainGo, true},
...
func (ts *FileClassifierTestSuite) TestDetectLanguage() {
	tests := []struct {
		...
		{"json", "data.json", "json"},
		{fileTypeShell, "script.sh", fileTypeShell},
...
func (ts *FileClassifierTestSuite) TestIsGeneratedFile() {
	tests := []struct {
		...
		{"normal go file", testFileMainGo, "", false},
...
func (ts *FileClassifierTestSuite) TestIsExcludedPath() {
	...
	tests := []struct {
		...
		{"normal file", testFileMainGo, false},
...
func (ts *FileClassifierTestSuite) TestMatchesPattern() {
	tests := []struct {
		...
		{"exact match", testFileTestGo, testFileTestGo, true},
		{"no match", testFileTestGo, testFileMainGo, false},
		{"wildcard suffix", testFileTestGo, testPatternGoStar, true},
		{"wildcard prefix", testFileTestGo, "test.*", true},
...
func (ts *FileClassifierTestSuite) TestGlobMatch() {
	tests := []struct {
		...
		{"simple suffix", testFileTestGo, testPatternGoStar, true},
		{"simple prefix", testFileTestGo, "test.*", true},
		{"no wildcard", testFileTestGo, testFileTestGo, true},
		{"multiple wildcards", "test_mock_service.go", "*_mock_*.go", true},
		{"doesn't match prefix", testFileMainGo, "test*", false},
		{"doesn't match suffix", "test.txt", testPatternGoStar, false},
	}
...
func (ts *FileClassifierTestSuite) TestGetFileStats() {
	...
	files := []string{
		ts.createFile(testFileMainGo, "package main"),
