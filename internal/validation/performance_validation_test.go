...
GO_PRE_COMMIT_TIMEOUT_SECONDS=10
GO_PRE_COMMIT_PARALLEL_WORKERS=0
GO_PRE_COMMIT_WHITESPACE_TIMEOUT=5
GO_PRE_COMMIT_EOF_TIMEOUT=5
...
func (s *PerformanceValidationTestSuite) createConstrainedPerformanceConfig() {
	constrainedConfig := `ENABLE_GO_PRE_COMMIT=true
GO_PRE_COMMIT_LOG_LEVEL=error
GO_PRE_COMMIT_ENABLE_WHITESPACE=true
GO_PRE_COMMIT_ENABLE_EOF=true
GO_PRE_COMMIT_TIMEOUT_SECONDS=5
GO_PRE_COMMIT_PARALLEL_WORKERS=1
GO_PRE_COMMIT_WHITESPACE_TIMEOUT=2
GO_PRE_COMMIT_EOF_TIMEOUT=2
